...
import { PlusSignCircleIcon, CancelCircleIcon } from '@hugeicons/core-free-icons';
  ...
  const getCardBrandIcon = (brand: string) => {
    switch (brand.toLowerCase()) {
      ...
      case 'american express':
        return <img src={amexLogo} alt="American Express" className="w-10 h-6 object-contain" />;
      default:
          ...
          <div className="p-6 pt-2">
            ...
            <div className="mb-6">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <p className="font-medium">Card ending **** {card.last4}</p>
                          <p className="text-sm text-gray-600">
                            Expiry date: {formatExpiryDate(card.expiryMonth, card.expiryYear)}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex items-center gap-3 pt-4 ">
                ...
                >
                <div className="flex items-center gap-2">
                    <HugeiconsIcon icon={PlusSignCircleIcon} className="w-5 h-5" />
